...
def loginUser(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            messages.error(request, "Username doens not exist")
...
def inbox(request):
    profile = request.user.profile
    messageRecords = profile.messages.all()
    unReadCount = messageRecords.filter(is_read = False).count
    context = {
